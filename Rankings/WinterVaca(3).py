...
def save_average_weatherscore(csv_file, output_file, file_number, target_month):
    ...
    fieldnames = ['Station ID', 'Latitude', 'Longitude', 'Name', 'Elevation', 'Years', 'Average Weatherscore']
    ...
    print(f"{file_number}th file average weatherscore added to {output_file}")
...
def process_directory(directory, output_file, target_month):
    ...
    print(f"All average Weatherscores with station metadata appended to {output_file}")
...
output_file = '/home/sam/PycharmProjects/best-weather-in-the-world/JanVacaRankings(2).csv'
