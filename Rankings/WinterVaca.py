...
def save_annual_weatherscore(csv_file, output_file, file_number, target_month):
    station_metadata = {}
    annual_weatherscore = calculate_average_weatherscore(csv_file, target_month)
...
def process_directory(directory, output_file, target_month):
    ...
    for idx, csv_file in enumerate(csv_files, start=1):
        ...
        save_annual_weatherscore(csv_file, output_file, idx, target_month)
