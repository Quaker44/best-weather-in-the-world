...
def calculate_average_weatherscore(csv_file):
    ...
    with open(csv_file, mode='r') as file:
        ...
        for row in csv_reader:
            ...
            if temperature_f == 9999.9 or dew_point_f == 9999.9 or wdsp == 999.9:
                continue
...
directory = '/Users/Quaker/Desktop/Weather_Station_Project/Raw Data Downloads/1994'
output_file = '/Users/Quaker/Desktop/Weather_Station_Project/annual_weatherscore_output(7).csv'
